...
const LearnNumbers = React.memo(function LearnNumbers() {
        ...
        <Dialog open={isDialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent className="sm:max-w-xs w-10/12 aspect-[4/5] bg-card text-card-foreground flex flex-col items-center justify-center p-4 rounded-lg shadow-2xl overflow-hidden">
            <div className="text-center flex flex-col items-center justify-center h-full">
              <p className="font-mono text-primary leading-none mb-3 sm:mb-4 text-5xl sm:text-6xl md:text-[90px]">
...
LearnNumbers.displayName = 'LearnNumbers';
