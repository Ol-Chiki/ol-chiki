...
interface HubItem {
  id: Extract<ActiveView, 'alphabet' | 'numbers' | 'words'>;
  title: string;
  description: string;
  icon: LucideIcon;
}
...
const BasicLearningHub = React.memo(function BasicLearningHub({ onSectionSelect }: BasicLearningHubProps) {
  return (
...
export default BasicLearningHub;
